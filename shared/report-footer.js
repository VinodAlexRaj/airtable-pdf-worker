...
const COMPACT_FOOTER_SPACER_BASIS = "18%";
...
function buildReportFooterTemplate({
    ...
    if (layout === "compact") {
        return `<style>.pdf-footer{position:relative;width:100%;height:28mm;box-sizing:border-box;overflow:hidden;background:#ffffff;font-family:Arial,sans-serif;font-size:10px;line-height:1.1;color:#536273;}.pdf-footer-inner{position:absolute;top:0;right:${COMPACT_FOOTER_RIGHT_INSET};bottom:0;left:${COMPACT_FOOTER_LEFT_INSET};box-sizing:border-box;padding-top:3mm;overflow:hidden;}.pdf-footer-row{display:flex;width:100%;height:100%;box-sizing:border-box;align-items:center;gap:8px;overflow:hidden;}.pdf-footer-info{flex:1 1 auto;min-width:0;overflow:hidden;}.pdf-footer-info-line{display:block;min-width:0;overflow:hidden;white-space:nowrap;line-height:1.1;}.pdf-footer-spacer{flex:0 0 ${COMPACT_FOOTER_SPACER_BASIS};min-width:0;}.pdf-footer-logos{flex:0 1 auto;min-width:0;max-width:18%;display:flex;align-items:center;justify-content:flex-end;overflow:hidden;white-space:nowrap;}.pdf-footer-cert-logo{display:block;width:250px;max-width:100%;height:auto;max-height:86px;object-fit:contain;border:0;}</style><div class="pdf-footer"><div class="pdf-footer-inner"><div class="pdf-footer-row"><div class="pdf-footer-info"><div class="pdf-footer-info-line">${footer.companyLine}</div><div class="pdf-footer-info-line">${footer.addressLine}</div><div class="pdf-footer-info-line">${footer.contactLine}</div></div><div class="pdf-footer-spacer" aria-hidden="true"></div><div class="pdf-footer-logos">${certificateImage}</div></div></div></div>`;
    }
